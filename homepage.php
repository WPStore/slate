...
get_header(); ?>
			...
			<div id="sections" class="clearfix">
				...
				<?php
				// Home page slider
				if ( 'enabled' == get_option( 'slate_theme_customizer_enable_slider' ) ) {
					get_template_part( 'content', 'home-slider' );
				}

				// Home page services
				if ( 'enabled' == get_option( 'slate_theme_customizer_enable_services' ) ) {
					get_template_part( 'content', 'home-services' );
				}

				// Home page portfolio
				if ( 'enabled' == get_option( 'slate_theme_customizer_enable_portfolio' ) ) {
					get_template_part( 'content', 'home-portfolio' );
				}

				// Home page blog posts
				if ( 'enabled' == get_option( 'slate_theme_customizer_enable_blog' ) ) {
					get_template_part( 'content', 'home-blog' );
				}

				// Home page testimonials
				if ( 'enabled' == get_option( 'slate_theme_customizer_enable_testimonials' ) ) {
